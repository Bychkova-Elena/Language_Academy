    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('students', models.ManyToManyField(blank=True, to='users.Students', verbose_name='Студенты')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='users.teachers', verbose_name='Учитель')),
            ],
            options={
                'verbose_name': 'Курс',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned', models.ManyToManyField(blank=True, to='users.Students', verbose_name='Назначенные')),
